...
class ThermometerWidget extends StatelessWidget {
  ...
  ThermometerWidget(
      ...
      this.stemWidth = 15.0 * 1.0,
      this.indicatorBulbWidth = 30.0 * 1.0,
      this.indicatorStemWidth = 7.0 * 1.0,
      this.temperature = 60.0 * 1.0,
      this.width = 40.0 * 1.0,
      this.height = 266.0 * 1.0}) {
...
class ThermometerWidgetPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    tempHeight = temperature / 230 * (maxTempHeight - size.width);
